app.controller("notificationcontroller", function ($scope,$http,$location,$rootScope) {
	...
	{
	$http.get("http://localhost:8080/colloboration_middleware/notifications/getAllNotis")
	...
	fetchAllNotifications();	
	 ...
	 $scope.deletenoti=function(id)
	 {
		console.log("in delete notig method")
		 $http.get("http://localhost:8080/colloboration_middleware/notifications/deleteNoti/"+id)
