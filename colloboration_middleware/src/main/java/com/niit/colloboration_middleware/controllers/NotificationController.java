...
public class notificationController {
	...
	public ResponseEntity<ArrayList<notification>> getAllNotis(HttpSession session){
		...
		ArrayList<notification> notis=(ArrayList<notification>)notificationsDAO.getAllNotifications(user.getEmail_id());
	...
	{
		ArrayList<notification> bc=notificationsDAO.getAllNotifications(us.getEmail_id());
